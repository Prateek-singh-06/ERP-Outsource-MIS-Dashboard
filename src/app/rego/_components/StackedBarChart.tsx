...
export default function StackedBarChart({
  ...
  const [topTenData,setTopTenData]=useState<RegoBarData[]|undefined>();
  ...
  return (
    ...
    >
      ...
      >
         {type=="all"?"Vehicle":type} Extra Charges Distribution
      </h2>
      {/* Description */}
      <p
        className="mb-6"
      ...
      >
        This chart shows the distribution of rego charges across different
        categories, including extra hour charge, extra KM charge, and base rent.
      </p>
      {/* Chart */}
      <div
      ...
      >
        <ResponsiveContainer width="100%" height="100%" minHeight={400}>
          ...
          >
            ...
            {/* <Bar dataKey="Base rent" stackId="a" fill="#82ca9d" /> */}
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
