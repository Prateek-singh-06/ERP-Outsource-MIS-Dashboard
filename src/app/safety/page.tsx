      ...
      {safety ? (
        <div className="mt-0 max-w-7xl min-h-screen mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-0">
            ...
            <Link
              href="https://docs.google.com/spreadsheets/d/1Geh-U247eGXRAAtrXbA9G1HidrX9Hzlj3i1hnb4jRCc/edit?gid=1258674082#gid=1258674082"
            ...
            >
              <DataCard
                ...
                progress={{
                  value:
                    Math.floor(
                      (safety.Summary.totalOpen * 100) /
                        safety.Summary.totalObservations
                    ) || 0,
                  max: 100,
                  label: "OPEN %",
                  color: "red",
            ...
            >
              <AgingCard
                ...
                closedAge={{
                  label: "Closed Issues",
                  value: safety.Summary.avgAgeofclosed,
                }}
                openAge={{
                  label: "Open Issues",
                  value: safety.Summary.avgAgeofopen,
                }}
                icon={
                  <svg
                    className="h-5 w-5"
